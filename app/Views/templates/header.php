...
<head>
    ...
    <title><?= isset($page_title) ? $page_title . " | " : "" ?>Konecta</title>
    <!-- Styles -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('home/agregar') ?>">
                        <i class="fa fa-plus-square"></i> Agregar Productos
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('home/listado') ?>">
                        <i class="fa fa-th-list"></i> Listado de Productos
                    </a>
                </li>
            </ul>
        </div>
        ...
        <?php if (!empty($session->getFlashdata('success_message'))): ?>
            <div class="alert alert-success rouded-0">
                <div class="d-flex">
                    ...
                    <div class="col-1 text-end"><a href="javascript:void(0)"
